<cfcomponent extends="coldbox.system.testing.BaseTestCase" output="false">
	...
	<cffunction name="setup" access="public" output="false" returntype="void">
		<cfscript>
			...
			protocol =  getMockBox().createMock(className="mailservices.model.AbstractProtocol").init(props);
		</cfscript>
	</cffunction>
	...
	<cffunction name="testSend" access="public" output="false" returntype="void" mxunit:expectedException="AbstractProtocol.AbstractMethodException">
		<cfscript>
			...
			payload = getMockBox().createMock(className="mailservices.model.Mail").init();
