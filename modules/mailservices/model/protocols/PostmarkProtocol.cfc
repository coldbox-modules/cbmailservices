...
----------------------------------------------------------------------->
<cfcomponent extends="mailservices.model.AbstractProtocol" output="false" hint="A mail protocol that sends via http://postmarkapp.com/">
...
<!------------------------------------------- PUBLIC ------------------------------------------>
	...
	<cffunction name="send" access="public" returntype="struct" output="true" hint="Send an email payload. Returns a struct: [error:boolean,errorArray:array,messageid:string]">
		<cfargument name="mail" required="true" type="mailservices.model.Mail" hint="The mail payload to send." />
