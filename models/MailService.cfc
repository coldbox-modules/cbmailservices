...
component accessors="true" singleton threadsafe {
     ...
     * @return
     */
    MailService function registerMailer( required name, required class, struct properties = {} ) {
        var thisMailer = { "class": arguments.class, "properties": arguments.properties, "transit": "" };
    ...
    Mail function send( required Mail mail ) {
        ...
        try {
            ...
            arguments.mail.setResults( { "error": true, "messages": [ "Error sending mail. #e.message# : #e.detail# : #e.stackTrace#" ] } );
