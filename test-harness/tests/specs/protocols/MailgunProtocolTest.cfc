    ...
    function run( testResults, testBox ) {
        ...
        describe( "Mailgun Protocol", function() {
            beforeEach( function( currentSpec ) {
                ...
                variables.protocol = createMock( "cbmailservices.models.protocols.MailgunProtocol" ).init( { apiKey: variables.apikey, domain: variables.domain, baseURL: variables.baseURL } );
            } );
            ...
            it( "data is formatted for sending to mailgun", function() {
                var payload = variables.mailservice
                    .newMail()
                    .configure( from = "info@ortussolutions.com", to = "info@ortussolutions.com", type = "html" )
